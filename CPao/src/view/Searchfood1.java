...
public class Searchfood1 extends JFrame {
	...
	public Searchfood1() {
		...
		table.getColumnModel().getColumn(4).setCellEditor(new MyRender1(table));
  		table.getColumnModel().getColumn(4).setCellRenderer(new MyRender1(table));
